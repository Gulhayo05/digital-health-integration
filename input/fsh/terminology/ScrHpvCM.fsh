Instance: scr-hpv-to-snomed
InstanceOf: ConceptMap
Usage: #definition
Title: "HPV Results to SNOMED CT"
Description: "Maps local UZ screening HPV result codes to SNOMED CT."
* url = "https://terminology.dhp.uz/ConceptMap/scr-hpv-to-snomed"
* name = "ScrHpvToSnomed"
* status = #draft
* experimental = false
* publisher = "DHP Integration"

* group.source = Canonical(ScrHpvCS)
* sourceScopeCanonical = Canonical(ScrHpvVS)
* group.target = $sct
