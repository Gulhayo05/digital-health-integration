...
* group.element[=].display = "Breast Imaging and Reporting and Data System"
...
* group.element[=].display = "Mammographic breast density"
...
* group.element[=].display = "Quality of visual image"
...
* group.element[=].display = "Body height"
...
* group.element[=].display = "Body weight"
