Instance: scr-cyt-to-snomed
InstanceOf: ConceptMap
Usage: #definition
Title: "Cytology Results to SNOMED CT"
Description: "Maps local UZ screening cytology result codes to SNOMED CT."
* url = "https://terminology.dhp.uz/ConceptMap/scr-cyt-to-snomed"
* name = "ScrCytToSnomed"
* status = #draft
* experimental = false
* publisher = "DHP Integration"

* group.source = Canonical(ScrCytCS)
* sourceScopeCanonical = Canonical(ScrCytVS)
* group.target = $sct
